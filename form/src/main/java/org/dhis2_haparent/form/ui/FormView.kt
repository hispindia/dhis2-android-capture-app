...
import org.dhis2_haparent.commons.ActivityResultObservable
import org.dhis2_haparent.commons.ActivityResultObserver
import org.dhis2_haparent.commons.Constants
import org.dhis2_haparent.commons.bindings.getFileFromGallery
import org.dhis2_haparent.commons.bindings.rotateImage
import org.dhis2_haparent.commons.dialogs.AlertBottomDialog
import org.dhis2_haparent.commons.dialogs.CustomDialog
import org.dhis2_haparent.commons.dialogs.bottomsheet.BottomSheetDialog
import org.dhis2_haparent.commons.dialogs.calendarpicker.CalendarPicker
import org.dhis2_haparent.commons.dialogs.calendarpicker.OnDatePickerListener
import org.dhis2_haparent.commons.dialogs.imagedetail.ImageDetailBottomDialog
import org.dhis2_haparent.commons.extensions.closeKeyboard
import org.dhis2_haparent.commons.extensions.truncate
import org.dhis2_haparent.commons.locationprovider.LocationProvider
import org.dhis2_haparent.commons.locationprovider.LocationSettingLauncher
import org.dhis2_haparent.commons.orgunitcascade.OrgUnitCascadeDialog
import org.dhis2_haparent.commons.orgunitcascade.OrgUnitCascadeDialog.CascadeOrgUnitCallbacks
import org.dhis2_haparent.form.R
import org.dhis2_haparent.form.data.DataIntegrityCheckResult
import org.dhis2_haparent.form.data.FormFileProvider
import org.dhis2_haparent.form.data.RulesUtilsProviderConfigurationError
import org.dhis2_haparent.form.data.SuccessfulResult
import org.dhis2_haparent.form.data.scan.ScanContract
import org.dhis2_haparent.form.data.toMessage
import org.dhis2_haparent.form.databinding.ViewFormBinding
import org.dhis2_haparent.form.di.Injector
import org.dhis2_haparent.form.model.FieldUiModel
import org.dhis2_haparent.form.model.FormRepositoryRecords
import org.dhis2_haparent.form.model.InfoUiModel
import org.dhis2_haparent.form.model.RowAction
import org.dhis2_haparent.form.model.UiRenderType
import org.dhis2_haparent.form.ui.dialog.OptionSetDialog
import org.dhis2_haparent.form.ui.dialog.QRDetailBottomDialog
import org.dhis2_haparent.form.ui.event.DialogDelegate
import org.dhis2_haparent.form.ui.event.RecyclerViewUiEvents
import org.dhis2_haparent.form.ui.idling.FormCountingIdlingResource
import org.dhis2_haparent.form.ui.intent.FormIntent
import org.dhis2_haparent.form.ui.provider.EnrollmentResultDialogUiProvider
import org.dhis2_haparent.maps.views.MapSelectorActivity
import org.dhis2_haparent.maps.views.MapSelectorActivity.Companion.DATA_EXTRA
import org.dhis2_haparent.maps.views.MapSelectorActivity.Companion.FIELD_UID
import org.dhis2_haparent.maps.views.MapSelectorActivity.Companion.LOCATION_TYPE_EXTRA
