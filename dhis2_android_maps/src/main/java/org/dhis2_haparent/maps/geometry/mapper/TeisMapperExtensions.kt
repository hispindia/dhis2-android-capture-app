...
fun Feature?.addTeiInfo(searchTeiModel: SearchTeiModel): Feature? {
    if (this != null) {
        addStringProperty(
            org.dhis2_haparent.maps.extensions.PROPERTY_FEATURE_SOURCE,
            org.dhis2_haparent.maps.extensions.FeatureSource.TEI.name
        )
        addStringProperty(
...
fun Feature?.addTeiEnrollmentInfo(searchTeiModel: SearchTeiModel): Feature? {
    if (this != null) {
        addStringProperty(
            org.dhis2_haparent.maps.extensions.PROPERTY_FEATURE_SOURCE,
            org.dhis2_haparent.maps.extensions.FeatureSource.ENROLLMENT.name
        )
        addStringProperty(
            MapTeisToFeatureCollection.ENROLLMENT_UID,
            searchTeiModel.selectedEnrollment.uid()
...
fun Feature?.addRelationshipInfo(
    ...
    if (this != null) {
        addStringProperty(
            org.dhis2_haparent.maps.extensions.PROPERTY_FEATURE_SOURCE,
            org.dhis2_haparent.maps.extensions.FeatureSource.RELATIONSHIP.name
        )
        addStringProperty(
...
fun Feature?.addTeiEventInfo(
    ...
    if (this != null) {
        addStringProperty(
            org.dhis2_haparent.maps.extensions.PROPERTY_FEATURE_SOURCE,
            org.dhis2_haparent.maps.extensions.FeatureSource.TRACKER_EVENT.name
        )
        addStringProperty(
            MapTeisToFeatureCollection.TEI_UID,
