package org.dhis2_haparent.maps.camera
    ...
    if (bounds.latNorth == 0.0 && bounds.latSouth == 0.0 &&
        ...
        this.easeCamera(
            CameraUpdateFactory.newLatLngBounds(
                bounds,
                org.dhis2_haparent.maps.camera.DEFAULT_BOUND_PADDING
            ),
            org.dhis2_haparent.maps.camera.DEFAULT_EASE_CAMERA_ANIM_DURATION
        )
    }
}
