...
import org.medhis2yes.data.forms.dataentry.fields.age.AgeViewModel;
import org.medhis2yes.data.forms.dataentry.fields.coordinate.CoordinateViewModel;
import org.medhis2yes.data.forms.dataentry.fields.datetime.DateTimeViewModel;
import org.medhis2yes.data.forms.dataentry.fields.edittext.EditTextViewModel;
import org.medhis2yes.data.forms.dataentry.fields.optionset.OptionSetViewModel;
import org.medhis2yes.data.forms.dataentry.fields.orgUnit.OrgUnitViewModel;
import org.medhis2yes.data.forms.dataentry.fields.picture.PictureViewModel;
import org.medhis2yes.data.forms.dataentry.fields.radiobutton.RadioButtonViewModel;
import org.medhis2yes.data.forms.dataentry.fields.scan.ScanTextViewModel;
import org.medhis2yes.data.forms.dataentry.fields.section.SectionViewModel;
import org.medhis2yes.data.forms.dataentry.fields.spinner.SpinnerViewModel;
import org.medhis2yes.data.forms.dataentry.fields.unsupported.UnsupportedViewModel;
import org.medhis2yes.data.forms.dataentry.fields.visualOptionSet.MatrixOptionSetModel;
import org.medhis2yes.form.model.FieldUiModel;
import org.medhis2yes.form.model.LegendValue;
...
import static org.medhis2yes.data.forms.dataentry.EnrollmentRepository.SINGLE_SECTION_UID;
import static org.medhis2yes.utils.Preconditions.isNull;
        ...
        switch (type) {
            ...
            case URL:
                if (fieldRendering != null && (fieldRendering.type().equals(ValueTypeRenderingType.QR_CODE) || fieldRendering.type().equals(ValueTypeRenderingType.BAR_CODE))) {
                    ...
                    return EditTextViewModel.create(id, label, mandatory, value, valueTypeHintMap.get(type), 1, type, section, editable, description, fieldRendering, objectStyle, fieldMask, ProgramStageSectionRenderingType.LISTING.toString(), !searchMode, searchMode, processor, legendValue);
                }
            case IMAGE:
