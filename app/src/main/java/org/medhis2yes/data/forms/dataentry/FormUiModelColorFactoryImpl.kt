        ...
        if (isBackgroundTransparent) {
            return mapOf(
                ...
                FormUiColorType.TEXT_PRIMARY to
                    ContextCompat.getColor(context, org.medhis2yes.R.color.textPrimary),
                FormUiColorType.FIELD_LABEL_TEXT to
                    ContextCompat.getColor(context, org.medhis2yes.R.color.text_black_A63),
                FormUiColorType.WARNING to
                    ContextCompat.getColor(context, org.medhis2yes.R.color.warning_color),
                FormUiColorType.ERROR to
                    ContextCompat.getColor(context, org.medhis2yes.R.color.error_color)
            )
        }
        return mapOf(
            FormUiColorType.PRIMARY to
