...
import org.medhis2yes.data.forms.dataentry.FormView;
import org.medhis2yes.data.forms.dataentry.ProgramAdapter;
...
import org.medhis2yes.databinding.ActivitySearchBinding;
...
import org.medhis2yes.uicomponents.map.managers.TeiMapManager;
import org.medhis2yes.uicomponents.map.mapper.MapRelationshipToRelationshipMapModel;
import org.medhis2yes.uicomponents.map.model.CarouselItemModel;
import org.medhis2yes.uicomponents.map.model.MapStyle;
import org.medhis2yes.usescases.enrollment.EnrollmentActivity;
...
import org.medhis2yes.usescases.searchTrackEntity.adapters.RelationshipLiveAdapter;
import org.medhis2yes.usescases.searchTrackEntity.adapters.SearchTeiLiveAdapter;
...
import org.medhis2yes.utils.customviews.BreakTheGlassBottomDialog;
...
import org.medhis2yes.utils.idlingresource.CountingIdlingResourceSingleton;
...
import static org.medhis2yes.utils.analytics.AnalyticsConstants.CHANGE_PROGRAM;
...
public class SearchTEActivity extends ActivityGlobalAbstract implements SearchTEContractsModule.View,
    ...
    public void setLiveData(LiveData<PagedList<SearchTeiModel>> liveData) {
        if (!fromRelationship) {
            liveData.observe(this, searchTeiModels -> {
                org.medhis2yes.data.tuples.Pair<String, Boolean> data = presenter.getMessage(searchTeiModels);
    ...
    public void setMap(TrackerMapData trackerMapData) {
        ...
        if (binding.messageContainer.getVisibility() == View.VISIBLE) {
            ...
            org.medhis2yes.data.tuples.Pair<String, Boolean> data = presenter.getMessage(trackerMapData.getTeiModels());
            if (data.val0().isEmpty()) {
                binding.messageContainer.setVisibility(GONE);
