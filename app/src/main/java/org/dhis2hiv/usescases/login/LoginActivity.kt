...
import org.dhis2hiv.Bindings.buildInfo
import org.dhis2hiv.Bindings.onRightDrawableClicked
import org.dhis2hiv.R
import org.dhis2hiv.data.server.UserManager
import org.dhis2hiv.data.tuples.Trio
import org.dhis2hiv.databinding.ActivityLoginBinding
import org.dhis2hiv.usescases.general.ActivityGlobalAbstract
import org.dhis2hiv.usescases.main.MainActivity
import org.dhis2hiv.usescases.qrScanner.ScanActivity
import org.dhis2hiv.usescases.sync.SyncActivity
import org.dhis2hiv.utils.Constants
import org.dhis2hiv.utils.Constants.ACCOUNT_RECOVERY
import org.dhis2hiv.utils.Constants.RQ_QR_SCANNER
import org.dhis2hiv.utils.D2ErrorUtils
...
import org.dhis2hiv.utils.WebViewActivity
import org.dhis2hiv.utils.WebViewActivity.Companion.WEB_VIEW_URL
import org.dhis2hiv.utils.analytics.CLICK
import org.dhis2hiv.utils.analytics.FORGOT_CODE
import org.dhis2hiv.utils.session.PIN_DIALOG_TAG
