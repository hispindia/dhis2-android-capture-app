...
import org.dhis2hiv.data.fingerprint.Type
import org.dhis2hiv.data.prefs.Preference
import org.dhis2hiv.data.prefs.Preference.Companion.PIN
import org.dhis2hiv.data.prefs.Preference.Companion.SESSION_LOCKED
import org.dhis2hiv.data.prefs.PreferenceProvider
import org.dhis2hiv.data.schedulers.SchedulerProvider
import org.dhis2hiv.data.server.UserManager
import org.dhis2hiv.usescases.main.MainActivity
import org.dhis2hiv.utils.Constants.PREFS_URLS
import org.dhis2hiv.utils.Constants.PREFS_USERS
import org.dhis2hiv.utils.Constants.SECURE_PASS
import org.dhis2hiv.utils.Constants.SECURE_SERVER_URL
import org.dhis2hiv.utils.Constants.SECURE_USER_NAME
import org.dhis2hiv.utils.Constants.SERVER
import org.dhis2hiv.utils.Constants.USER
import org.dhis2hiv.utils.Constants.USER_ASKED_CRASHLYTICS
import org.dhis2hiv.utils.Constants.USER_TEST_ANDROID
import org.dhis2hiv.utils.TestingCredential
import org.dhis2hiv.utils.analytics.ACCOUNT_RECOVERY
import org.dhis2hiv.utils.analytics.AnalyticsHelper
import org.dhis2hiv.utils.analytics.CLICK
import org.dhis2hiv.utils.analytics.LOGIN
import org.dhis2hiv.utils.analytics.SERVER_QR_SCANNER
