...
import org.dhis2hiv.Bindings.TrackedEntityInstanceExtensionsKt;
import org.dhis2hiv.Bindings.ValueExtensionsKt;
...
import org.dhis2hiv.usescases.teiDashboard.dashboardfragments.relationships.RelationshipViewModel;
...
import org.dhis2hiv.utils.ValueUtils;
...
public class SearchRepositoryImpl implements SearchRepository {
    ...
    private void setRelationshipsInfo(@NonNull SearchTeiModel searchTeiModel, Program selectedProgram) {
        ...
        for (Relationship relationship : relationships) {
            ...
            if (relationship.from().trackedEntityInstance() != null && relationship.to().trackedEntityInstance() == null) {
