...
import org.dhis2hiv.Bindings.ExtensionsKt;
import org.dhis2hiv.Bindings.ViewExtensionsKt;
import org.dhis2hiv.R;
import org.dhis2hiv.animations.CarouselViewAnimations;
import org.dhis2hiv.data.forms.dataentry.ProgramAdapter;
import org.dhis2hiv.data.forms.dataentry.fields.RowAction;
import org.dhis2hiv.data.tuples.Trio;
import org.dhis2hiv.databinding.ActivitySearchBinding;
import org.dhis2hiv.uicomponents.map.carousel.CarouselAdapter;
import org.dhis2hiv.uicomponents.map.geometry.mapper.EventsByProgramStage;
import org.dhis2hiv.uicomponents.map.layer.MapLayerDialog;
import org.dhis2hiv.uicomponents.map.managers.TeiMapManager;
import org.dhis2hiv.uicomponents.map.mapper.MapRelationshipToRelationshipMapModel;
import org.dhis2hiv.uicomponents.map.model.CarouselItemModel;
import org.dhis2hiv.uicomponents.map.model.EventUiComponentModel;
import org.dhis2hiv.uicomponents.map.model.MapStyle;
import org.dhis2hiv.usescases.coodinates.CoordinatesView;
import org.dhis2hiv.usescases.enrollment.EnrollmentActivity;
import org.dhis2hiv.usescases.general.ActivityGlobalAbstract;
import org.dhis2hiv.usescases.orgunitselector.OUTreeActivity;
import org.dhis2hiv.usescases.searchTrackEntity.adapters.FormAdapter;
import org.dhis2hiv.usescases.searchTrackEntity.adapters.RelationshipLiveAdapter;
import org.dhis2hiv.usescases.searchTrackEntity.adapters.SearchTeiLiveAdapter;
import org.dhis2hiv.usescases.searchTrackEntity.adapters.SearchTeiModel;
import org.dhis2hiv.usescases.teiDashboard.TeiDashboardMobileActivity;
import org.dhis2hiv.utils.ColorUtils;
import org.dhis2hiv.utils.Constants;
import org.dhis2hiv.utils.DateUtils;
import org.dhis2hiv.utils.HelpManager;
import org.dhis2hiv.utils.NetworkUtils;
import org.dhis2hiv.utils.customviews.ImageDetailBottomDialog;
...
import org.dhis2hiv.utils.idlingresource.CountingIdlingResourceSingleton;
...
import static org.dhis2hiv.uicomponents.map.geometry.mapper.featurecollection.MapRelationshipsToFeatureCollection.RELATIONSHIP_UID;
import static org.dhis2hiv.usescases.eventsWithoutRegistration.eventInitial.EventInitialPresenter.ACCESS_LOCATION_PERMISSION_REQUEST;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.CHANGE_PROGRAM;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.CLICK;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.SHOW_HELP;
