...
import org.dhis2hiv.data.dhislogic.DhisEnrollmentUtils;
import org.dhis2hiv.data.prefs.Preference;
import org.dhis2hiv.data.prefs.PreferenceProvider;
import org.dhis2hiv.usescases.main.program.ProgramViewModel;
import org.dhis2hiv.utils.analytics.AnalyticsHelper;

import static org.dhis2hiv.utils.analytics.AnalyticsConstants.CLICK;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.DESELECT_ENROLLMENT;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.ENROLL_FROM_LIST;
