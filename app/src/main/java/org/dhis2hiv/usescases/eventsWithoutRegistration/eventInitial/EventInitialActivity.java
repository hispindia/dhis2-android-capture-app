...
import org.dhis2hiv.data.forms.FormSectionViewModel;
...
import org.dhis2hiv.data.prefs.Preference;
import org.dhis2hiv.data.prefs.PreferenceProvider;
import org.dhis2hiv.databinding.ActivityEventInitialBinding;
import org.dhis2hiv.databinding.CategorySelectorBinding;
import org.dhis2hiv.databinding.WidgetDatepickerBinding;
import org.dhis2hiv.usescases.coodinates.CoordinatesView;
import org.dhis2hiv.usescases.eventsWithoutRegistration.eventCapture.EventCaptureActivity;
import org.dhis2hiv.usescases.general.ActivityGlobalAbstract;
import org.dhis2hiv.usescases.qrCodes.eventsworegistration.QrEventsWORegistrationActivity;
import org.dhis2hiv.utils.ColorUtils;
import org.dhis2hiv.utils.Constants;
import org.dhis2hiv.utils.DateUtils;
import org.dhis2hiv.utils.DialogClickListener;
import org.dhis2hiv.utils.EventCreationType;
import org.dhis2hiv.utils.EventMode;
import org.dhis2hiv.utils.HelpManager;
import org.dhis2hiv.utils.analytics.AnalyticsConstants;
import org.dhis2hiv.utils.category.CategoryDialog;
import org.dhis2hiv.utils.customviews.CatOptionPopUp;
import org.dhis2hiv.utils.customviews.CustomDialog;
import org.dhis2hiv.utils.customviews.OrgUnitDialog;
import org.dhis2hiv.utils.customviews.PeriodDialog;
...
import static org.dhis2hiv.utils.Constants.ENROLLMENT_UID;
import static org.dhis2hiv.utils.Constants.EVENT_CREATION_TYPE;
import static org.dhis2hiv.utils.Constants.EVENT_PERIOD_TYPE;
import static org.dhis2hiv.utils.Constants.ONE_TIME;
import static org.dhis2hiv.utils.Constants.ORG_UNIT;
import static org.dhis2hiv.utils.Constants.PERMANENT;
import static org.dhis2hiv.utils.Constants.PROGRAM_UID;
import static org.dhis2hiv.utils.Constants.TRACKED_ENTITY_INSTANCE;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.CLICK;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.CREATE_EVENT;
import static org.dhis2hiv.utils.analytics.AnalyticsConstants.DELETE_EVENT;
