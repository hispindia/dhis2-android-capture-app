...
import org.dhis2hiv.databinding.ActivityMainBinding
import org.dhis2hiv.usescases.about.AboutFragment
import org.dhis2hiv.usescases.development.DevelopmentActivity
import org.dhis2hiv.usescases.general.ActivityGlobalAbstract
import org.dhis2hiv.usescases.general.FragmentGlobalAbstract
import org.dhis2hiv.usescases.jira.JiraFragment
import org.dhis2hiv.usescases.login.LoginActivity
import org.dhis2hiv.usescases.main.program.ProgramFragment
import org.dhis2hiv.usescases.qrReader.QrReaderFragment
import org.dhis2hiv.usescases.settings.SyncManagerFragment
import org.dhis2hiv.usescases.teiDashboard.nfcdata.NfcDataWriteActivity
import org.dhis2hiv.utils.Constants
import org.dhis2hiv.utils.DateUtils
import org.dhis2hiv.utils.analytics.BLOCK_SESSION
import org.dhis2hiv.utils.analytics.CLICK
import org.dhis2hiv.utils.analytics.CLOSE_SESSION
import org.dhis2hiv.utils.extension.navigateTo
