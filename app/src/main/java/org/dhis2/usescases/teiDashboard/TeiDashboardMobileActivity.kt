...
import org.dhis2.usescases.report.ReportActivity
        ...
        binding.moreOptions.setContent {
            ...
            MoreOptionsWithDropDownMenuButton(
                ...
                when (itemId) {
                    ...
                    EnrollmentMenuItem.REPORT -> {
                        // Launch report functionality
//                        view.showReportScreen(enrollmentUid)
