package org.hisp.dhis.android.uphmis.data.forms.dataentry.fields.spinner;
...
import org.hisp.dhis.android.uphmis.data.forms.dataentry.fields.FormViewHolder;
import org.hisp.dhis.android.uphmis.data.forms.dataentry.fields.RowAction;
import org.hisp.dhis.android.uphmis.data.tuples.Trio;
import org.hisp.dhis.android.uphmis.utils.Constants;
import org.hisp.dhis.android.uphmis.utils.CustomViews.OptionSetDialog;
import org.hisp.dhis.android.uphmis.utils.CustomViews.OptionSetOnClickListener;
...
//        @Sou Todo for disable approve/rejection
        Bindings.setObjectStyle(iconView, itemView, viewModel.uid());
        if(viewModel.uid().equals(Constants.APPROVAL_DE))
        {
        ...
        else
        {
         ...
         //option code is already transformed to value in the fieldviewmodelfactory implementation
