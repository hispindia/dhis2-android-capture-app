package org.dhis2afgamis.data.forms.dataentry.fields.edittext;
...
import org.dhis2afgamis.data.forms.dataentry.fields.FormViewHolder;
import org.dhis2afgamis.data.forms.dataentry.fields.RowAction;
import org.dhis2afgamis.databinding.FormEditTextCustomBinding;
import org.dhis2afgamis.utils.Constants;
import org.dhis2afgamis.utils.Preconditions;
import org.dhis2afgamis.utils.ValidationUtils;
import org.dhis2afgamis.utils.customviews.TextInputAutoCompleteTextView;
...
public class EditTextCustomHolder extends FormViewHolder {
    ...
    public void update(@NonNull FieldViewModel model) {
        ...
        if(fieldUid.equals("RH9t0P0r7Dd")||fieldUid.equals("deLnry4UDR4"))
        {
