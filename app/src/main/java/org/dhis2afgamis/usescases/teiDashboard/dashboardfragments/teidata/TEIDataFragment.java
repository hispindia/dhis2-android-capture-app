...
import org.dhis2afgamis.databinding.FragmentTeiDataBinding;
import org.dhis2afgamis.usescases.eventsWithoutRegistration.eventInitial.EventInitialActivity;
...
import org.dhis2afgamis.usescases.programStageSelection.ProgramStageSelectionActivity;
import org.dhis2afgamis.usescases.teiDashboard.DashboardProgramModel;
import org.dhis2afgamis.usescases.teiDashboard.DashboardViewModel;
import org.dhis2afgamis.usescases.teiDashboard.TeiDashboardMobileActivity;
import org.dhis2afgamis.usescases.teiDashboard.dashboardfragments.teidata.teievents.EventAdapter;
import org.dhis2afgamis.usescases.teiDashboard.dashboardfragments.teidata.teievents.EventViewModel;
import org.dhis2afgamis.usescases.teiDashboard.dashboardfragments.teidata.teievents.EventViewModelType;
import org.dhis2afgamis.utils.Constants;
import org.dhis2afgamis.utils.DateUtils;
import org.dhis2afgamis.utils.DialogClickListener;
import org.dhis2afgamis.utils.EventCreationType;
import org.dhis2afgamis.utils.ObjectStyleUtils;
import org.dhis2afgamis.utils.OrientationUtilsKt;
import org.dhis2afgamis.utils.category.CategoryDialog;
...
import static org.dhis2afgamis.utils.Constants.ENROLLMENT_UID;
import static org.dhis2afgamis.utils.Constants.EVENT_CREATION_TYPE;
import static org.dhis2afgamis.utils.Constants.EVENT_PERIOD_TYPE;
import static org.dhis2afgamis.utils.Constants.EVENT_REPEATABLE;
import static org.dhis2afgamis.utils.Constants.EVENT_SCHEDULE_INTERVAL;
import static org.dhis2afgamis.utils.Constants.ORG_UNIT;
import static org.dhis2afgamis.utils.Constants.PROGRAM_UID;
import static org.dhis2afgamis.utils.Constants.TRACKED_ENTITY_INSTANCE;
import static org.dhis2afgamis.utils.analytics.AnalyticsConstants.CREATE_EVENT_TEI;
import static org.dhis2afgamis.utils.analytics.AnalyticsConstants.TYPE_EVENT_TEI;
