...
import org.dhis2afgamis.Bindings.ExtensionsKt;
import org.dhis2afgamis.Bindings.ViewExtensionsKt;
import org.dhis2afgamis.R;
import org.dhis2afgamis.animations.CarouselViewAnimations;
import org.dhis2afgamis.data.forms.dataentry.ProgramAdapter;
import org.dhis2afgamis.data.forms.dataentry.fields.RowAction;
import org.dhis2afgamis.data.tuples.Trio;
import org.dhis2afgamis.databinding.ActivitySearchBinding;
import org.dhis2afgamis.uicomponents.map.carousel.CarouselAdapter;
import org.dhis2afgamis.uicomponents.map.geometry.mapper.EventsByProgramStage;
import org.dhis2afgamis.uicomponents.map.layer.MapLayerDialog;
import org.dhis2afgamis.uicomponents.map.managers.TeiMapManager;
import org.dhis2afgamis.uicomponents.map.mapper.MapRelationshipToRelationshipMapModel;
import org.dhis2afgamis.uicomponents.map.model.CarouselItemModel;
import org.dhis2afgamis.uicomponents.map.model.EventUiComponentModel;
import org.dhis2afgamis.uicomponents.map.model.MapStyle;
import org.dhis2afgamis.usescases.coodinates.CoordinatesView;
import org.dhis2afgamis.usescases.enrollment.EnrollmentActivity;
import org.dhis2afgamis.usescases.general.ActivityGlobalAbstract;
import org.dhis2afgamis.usescases.orgunitselector.OUTreeActivity;
import org.dhis2afgamis.usescases.searchTrackEntity.adapters.FormAdapter;
import org.dhis2afgamis.usescases.searchTrackEntity.adapters.RelationshipLiveAdapter;
import org.dhis2afgamis.usescases.searchTrackEntity.adapters.SearchTeiLiveAdapter;
import org.dhis2afgamis.usescases.searchTrackEntity.adapters.SearchTeiModel;
import org.dhis2afgamis.usescases.teiDashboard.TeiDashboardMobileActivity;
import org.dhis2afgamis.utils.ColorUtils;
import org.dhis2afgamis.utils.Constants;
import org.dhis2afgamis.utils.DateUtils;
import org.dhis2afgamis.utils.HelpManager;
import org.dhis2afgamis.utils.NetworkUtils;
import org.dhis2afgamis.utils.customviews.ImageDetailBottomDialog;
import org.dhis2afgamis.utils.customviews.ScanTextView;
...
import static org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapRelationshipsToFeatureCollection.RELATIONSHIP_UID;
import static org.dhis2afgamis.usescases.eventsWithoutRegistration.eventInitial.EventInitialPresenter.ACCESS_LOCATION_PERMISSION_REQUEST;
import static org.dhis2afgamis.utils.analytics.AnalyticsConstants.CHANGE_PROGRAM;
import static org.dhis2afgamis.utils.analytics.AnalyticsConstants.CLICK;
import static org.dhis2afgamis.utils.analytics.AnalyticsConstants.SHOW_HELP;
