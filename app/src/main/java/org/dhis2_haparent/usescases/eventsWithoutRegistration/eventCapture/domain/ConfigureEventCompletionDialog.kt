package org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain

import org.dhis2_haparent.commons.data.FieldWithIssue
import org.dhis2_haparent.commons.data.IssueType
import org.dhis2_haparent.commons.dialogs.bottomsheet.BottomSheetDialogUiModel
import org.dhis2_haparent.commons.dialogs.bottomsheet.DialogButtonStyle.CompleteButton
import org.dhis2_haparent.commons.dialogs.bottomsheet.DialogButtonStyle.MainButton
import org.dhis2_haparent.commons.dialogs.bottomsheet.DialogButtonStyle.SecondaryButton
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain.ConfigureEventCompletionDialog.DialogType.COMPLETE_ERROR
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain.ConfigureEventCompletionDialog.DialogType.ERROR
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain.ConfigureEventCompletionDialog.DialogType.MANDATORY
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain.ConfigureEventCompletionDialog.DialogType.SUCCESSFUL
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.domain.ConfigureEventCompletionDialog.DialogType.WARNING
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventCapture.model.EventCompletionButtons
