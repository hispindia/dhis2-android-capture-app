...
import org.dhis2_haparent.commons.data.EventCreationType.ADDNEW
import org.dhis2_haparent.commons.data.EventCreationType.DEFAULT
import org.dhis2_haparent.commons.data.EventCreationType.SCHEDULE
import org.dhis2_haparent.commons.date.DateUtils
        ...
        getProgramStage().hideDueDate()?.let { hideDueDate ->
            if (creationType == SCHEDULE && hideDueDate) {
                return if (periodType != null) {
                    ...
                    org.dhis2_haparent.utils.DateUtils.getInstance().getNextPeriod(
                        null,
                        calendar.time, 0
                    )
                }
        ...
        repository.getProgram()?.let { program ->
            if (periodType == null) {
                if (program.expiryPeriodType() != null) {
                    ...
                    return org.dhis2_haparent.utils.DateUtils.getInstance().expDate(
                        null,
                        expiryDays,
                ...
                var minDate = org.dhis2_haparent.utils.DateUtils.getInstance().expDate(
                    null,
                    program.expiryDays() ?: 0,
                    periodType
                )
                val lastPeriodDate = org.dhis2_haparent.utils.DateUtils.getInstance().getNextPeriod(
                    periodType,
                    minDate,
                    -1,
                    true
                ...
                if (lastPeriodDate.after(
                    ...
                    minDate = org.dhis2_haparent.utils.DateUtils.getInstance()
