...
import org.dhis2_haparent.Bindings.app
import org.dhis2_haparent.Bindings.buildInfo
import org.dhis2_haparent.Bindings.onRightDrawableClicked
import org.dhis2_haparent.R
import org.dhis2_haparent.commons.Constants
import org.dhis2_haparent.commons.Constants.ACCOUNT_RECOVERY
import org.dhis2_haparent.commons.Constants.ACCOUNT_USED
import org.dhis2_haparent.commons.Constants.EXTRA_DATA
import org.dhis2_haparent.commons.Constants.SERVER
import org.dhis2_haparent.commons.Constants.SESSION_DIALOG_RQ
import org.dhis2_haparent.commons.Constants.USER
import org.dhis2_haparent.commons.data.tuples.Trio
...
import org.dhis2_haparent.data.server.OpenIdSession
import org.dhis2_haparent.data.server.UserManager
import org.dhis2_haparent.databinding.ActivityLoginBinding
import org.dhis2_haparent.usescases.about.PolicyView
import org.dhis2_haparent.usescases.general.ActivityGlobalAbstract
import org.dhis2_haparent.usescases.login.accounts.AccountsActivity
import org.dhis2_haparent.usescases.login.auth.AuthServiceModel
import org.dhis2_haparent.usescases.login.auth.OpenIdProviders
import org.dhis2_haparent.usescases.main.MainActivity
import org.dhis2_haparent.usescases.qrScanner.ScanActivity
import org.dhis2_haparent.usescases.sync.SyncActivity
import org.dhis2_haparent.utils.NetworkUtils
import org.dhis2_haparent.utils.TestingCredential
import org.dhis2_haparent.utils.WebViewActivity
import org.dhis2_haparent.utils.WebViewActivity.Companion.WEB_VIEW_URL
import org.dhis2_haparent.utils.analytics.CLICK
import org.dhis2_haparent.utils.analytics.FORGOT_CODE
import org.dhis2_haparent.utils.session.PIN_DIALOG_TAG
import org.dhis2_haparent.utils.session.PinDialog
