...
import static org.dhis2_haparent.commons.Constants.ENROLLMENT_UID;
import static org.dhis2_haparent.commons.Constants.EVENT_CREATION_TYPE;
import static org.dhis2_haparent.commons.Constants.EVENT_PERIOD_TYPE;
import static org.dhis2_haparent.commons.Constants.EVENT_REPEATABLE;
import static org.dhis2_haparent.commons.Constants.EVENT_SCHEDULE_INTERVAL;
import static org.dhis2_haparent.commons.Constants.ORG_UNIT;
import static org.dhis2_haparent.commons.Constants.PROGRAM_UID;
import static org.dhis2_haparent.commons.Constants.TRACKED_ENTITY_INSTANCE;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.CREATE_EVENT_TEI;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.TYPE_EVENT_TEI;
...
import org.dhis2_haparent.commons.animations.ViewAnimationsKt;
import org.dhis2_haparent.commons.data.EventCreationType;
import org.dhis2_haparent.commons.data.EventViewModel;
import org.dhis2_haparent.commons.data.StageSection;
import org.dhis2_haparent.commons.dialogs.CustomDialog;
import org.dhis2_haparent.commons.dialogs.DialogClickListener;
...
import org.dhis2_haparent.commons.resources.ObjectStyleUtils;
import org.dhis2_haparent.commons.sync.ConflictType;
import org.dhis2_haparent.databinding.FragmentTeiDataBinding;
import org.dhis2_haparent.usescases.eventsWithoutRegistration.eventInitial.EventInitialActivity;
import org.dhis2_haparent.usescases.general.FragmentGlobalAbstract;
import org.dhis2_haparent.usescases.programStageSelection.ProgramStageSelectionActivity;
import org.dhis2_haparent.usescases.teiDashboard.DashboardProgramModel;
import org.dhis2_haparent.usescases.teiDashboard.DashboardViewModel;
import org.dhis2_haparent.usescases.teiDashboard.TeiDashboardMobileActivity;
import org.dhis2_haparent.usescases.teiDashboard.dashboardfragments.teidata.teievents.CategoryDialogInteractions;
import org.dhis2_haparent.usescases.teiDashboard.dashboardfragments.teidata.teievents.EventAdapter;
import org.dhis2_haparent.usescases.teiDashboard.dashboardfragments.teidata.teievents.EventCatComboOptionSelector;
import org.dhis2_haparent.usescases.teiDashboard.ui.DetailsButtonKt;
import org.dhis2_haparent.utils.DateUtils;
import org.dhis2_haparent.utils.dialFloatingActionButton.DialItem;
import org.dhis2_haparent.utils.granularsync.SyncStatusDialog;
