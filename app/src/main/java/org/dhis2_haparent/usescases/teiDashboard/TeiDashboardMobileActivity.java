...
import static org.dhis2_haparent.commons.Constants.TEI_UID;
import static org.dhis2_haparent.usescases.teiDashboard.DataConstantsKt.CHANGE_PROGRAM;
import static org.dhis2_haparent.usescases.teiDashboard.DataConstantsKt.CHANGE_PROGRAM_ENROLLMENT;
import static org.dhis2_haparent.usescases.teiDashboard.DataConstantsKt.GO_TO_ENROLLMENT;
import static org.dhis2_haparent.usescases.teiDashboard.DataConstantsKt.GO_TO_ENROLLMENT_PROGRAM;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.CLICK;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.SHARE_TEI;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.SHOW_HELP;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.TYPE_QR;
import static org.dhis2_haparent.utils.analytics.AnalyticsConstants.TYPE_SHARE;
...
import org.dhis2_haparent.databinding.ActivityDashboardMobileBinding;
import org.dhis2_haparent.ui.ThemeManager;
import org.dhis2_haparent.usescases.enrollment.EnrollmentActivity;
import org.dhis2_haparent.usescases.general.ActivityGlobalAbstract;
import org.dhis2_haparent.usescases.qrCodes.QrActivity;
import org.dhis2_haparent.usescases.teiDashboard.adapters.DashboardPagerAdapter;
import org.dhis2_haparent.usescases.teiDashboard.dashboardfragments.relationships.MapButtonObservable;
import org.dhis2_haparent.usescases.teiDashboard.dashboardfragments.teidata.TEIDataFragment;
import org.dhis2_haparent.usescases.teiDashboard.teiProgramList.TeiProgramListActivity;
import org.dhis2_haparent.utils.HelpManager;
import org.dhis2_haparent.utils.OrientationUtilsKt;
