...
import org.dhis2_haparent.commons.Constants.TEI_UID
...
import org.dhis2_haparent.databinding.EnrollmentActivityBinding
import org.dhis2_haparent.form.data.GeometryController
import org.dhis2_haparent.form.data.GeometryParserImpl
import org.dhis2_haparent.form.model.EnrollmentRecords
import org.dhis2_haparent.form.ui.FormView
...
import org.dhis2_haparent.usescases.events.ScheduledEventActivity
        ...
        formView = FormView.Builder()
            ...
            .setRecords(
                EnrollmentRecords(
                    ...
                    enrollmentMode = org.dhis2_haparent.form.model.EnrollmentMode.valueOf(
                        enrollmentMode.name
                    )
                )
            )
