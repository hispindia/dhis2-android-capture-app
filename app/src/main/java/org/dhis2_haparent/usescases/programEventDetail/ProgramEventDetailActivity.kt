...
import org.dhis2_haparent.Bindings.clipWithRoundedCorners
...
import org.dhis2_haparent.commons.matomo.Actions.Companion.CREATE_EVENT
import org.dhis2_haparent.commons.network.NetworkUtils
import org.dhis2_haparent.commons.orgunitselector.OUTreeFragment.Companion.newInstance
...
import org.dhis2_haparent.commons.sync.OnDismissListener
import org.dhis2_haparent.databinding.ActivityProgramEventDetailBinding
...
import org.dhis2_haparent.usescases.programEventDetail.ProgramEventDetailViewModel.EventProgramScreen
import org.dhis2_haparent.usescases.programEventDetail.eventList.EventListFragment
import org.dhis2_haparent.usescases.programEventDetail.eventMap.EventMapFragment
import org.dhis2_haparent.utils.DateUtils
import org.dhis2_haparent.utils.EventMode
import org.dhis2_haparent.utils.analytics.DATA_CREATION
