...
import org.dhis2_haparent.databinding.FragmentProgramEventDetailMapBinding
...
class EventMapFragment :
    ...
    @Inject
    lateinit var mapNavigation: org.dhis2_haparent.maps.ExternalMapNavigation

    private var eventMapManager: org.dhis2_haparent.maps.managers.EventMapManager? = null
    ...
    override fun onCreateView(
        ...
        binding.apply {
            eventMapManager = org.dhis2_haparent.maps.managers.EventMapManager(mapView)
