...
import org.dhis2_haparent.animations.CarouselViewAnimations;
import org.dhis2_haparent.commons.di.dagger.PerActivity;
import org.dhis2_haparent.commons.filters.DisableHomeFiltersFromSettingsApp;
...
import org.dhis2_haparent.data.enrollment.EnrollmentUiDataHelper;
...
import org.dhis2_haparent.data.sorting.SearchSortingValueSetter;
...
import org.dhis2_haparent.maps.geometry.bound.BoundsGeometry;
import org.dhis2_haparent.maps.geometry.bound.GetBoundingBox;
import org.dhis2_haparent.maps.geometry.line.MapLineRelationshipToFeature;
import org.dhis2_haparent.maps.geometry.mapper.MapGeometryToFeature;
import org.dhis2_haparent.maps.geometry.mapper.feature.MapCoordinateFieldToFeature;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapAttributeToFeature;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapCoordinateFieldToFeatureCollection;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapDataElementToFeature;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapRelationshipsToFeatureCollection;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapTeiEventsToFeatureCollection;
import org.dhis2_haparent.maps.geometry.mapper.featurecollection.MapTeisToFeatureCollection;
import org.dhis2_haparent.maps.geometry.point.MapPointToFeature;
import org.dhis2_haparent.maps.geometry.polygon.MapPolygonPointToFeature;
import org.dhis2_haparent.maps.geometry.polygon.MapPolygonToFeature;
import org.dhis2_haparent.maps.mapper.EventToEventUiComponent;
...
import org.dhis2_haparent.maps.utils.DhisMapUtils;
