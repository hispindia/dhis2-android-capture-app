...
import org.dhis2_haparent.databinding.DialogPeriodBinding;
...
public class PeriodDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.selectedPeriod.setText(periodUtils.getPeriodUIString(period, currentDate, Locale.getDefault()));
