...
import org.dhis2_haparent.Bindings.checkSMSPermission
import org.dhis2_haparent.Bindings.showSMS
import org.dhis2_haparent.R
import org.dhis2_haparent.commons.bindings.setStateIcon
import org.dhis2_haparent.commons.date.toDateSpan
...
import org.dhis2_haparent.databinding.SyncBottomDialogBinding
import org.dhis2_haparent.usescases.settings.ErrorDialog
import org.dhis2_haparent.usescases.sms.InputArguments
...
import org.dhis2_haparent.utils.analytics.SYNC_GRANULAR
import org.dhis2_haparent.utils.analytics.SYNC_GRANULAR_ONLINE
import org.dhis2_haparent.utils.analytics.SYNC_GRANULAR_SMS
import org.dhis2_haparent.utils.customviews.MessageAmountDialog
...
class SyncStatusDialog : BottomSheetDialogFragment(), GranularSyncContracts.View {
    ...
    private fun setNetworkMessage() {
        if (!networkUtils.isOnline()) {
            ...
            if (binding!!.syncIcon.tag == org.dhis2_haparent.commons.R.drawable.ic_status_synced) {
