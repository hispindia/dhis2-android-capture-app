...
import org.dhis2_haparent.maps.model.RelationshipDirection
import org.dhis2_haparent.uicomponents.map.mocks.GeometryDummy.FROM_COORDINATES
import org.dhis2_haparent.uicomponents.map.mocks.GeometryDummy.TO_COORDINATES
import org.dhis2_haparent.uicomponents.map.mocks.RelationshipViewModelDummy
import org.dhis2_haparent.uicomponents.map.mocks.RelationshipViewModelDummy.DISPLAY_NAME
import org.dhis2_haparent.uicomponents.map.mocks.RelationshipViewModelDummy.EMPTY
import org.dhis2_haparent.uicomponents.map.mocks.RelationshipViewModelDummy.UID
...
class MapRelationshipToRelationshipMapModelTest {
    ...
    private val mapper = org.dhis2_haparent.maps.mapper.MapRelationshipToRelationshipMapModel()
