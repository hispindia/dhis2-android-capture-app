package org.dhis2_haparent.uicomponents.map.geometry.point
...
class PointViewModelTest {
    ...
    private lateinit var pointViewModel: org.dhis2_haparent.maps.geometry.point.PointViewModel

    @Before
    fun setup() {
        pointViewModel = org.dhis2_haparent.maps.geometry.point.PointViewModel()
    }
