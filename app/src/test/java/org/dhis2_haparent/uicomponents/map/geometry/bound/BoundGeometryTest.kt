package org.dhis2_haparent.uicomponents.map.geometry.bound
...
class BoundGeometryTest {
    ...
    private lateinit var boundsGeometry: org.dhis2_haparent.maps.geometry.bound.BoundsGeometry

    @Test
    fun `Should init or reset`() {
        boundsGeometry = org.dhis2_haparent.maps.geometry.bound.BoundsGeometry()
