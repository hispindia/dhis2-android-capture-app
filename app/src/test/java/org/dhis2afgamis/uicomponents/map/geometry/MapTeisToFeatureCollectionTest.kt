package org.dhis2afgamis.uicomponents.map.geometry
...
import org.dhis2afgamis.uicomponents.map.geometry.bound.BoundsGeometry
import org.dhis2afgamis.uicomponents.map.geometry.bound.GetBoundingBox
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapRelationshipsToFeatureCollection
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapTeisToFeatureCollection
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapTeisToFeatureCollection.Companion.ENROLLMENT
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapTeisToFeatureCollection.Companion.ENROLLMENT_UID
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapTeisToFeatureCollection.Companion.TEI
import org.dhis2afgamis.uicomponents.map.geometry.mapper.featurecollection.MapTeisToFeatureCollection.Companion.TEI_IMAGE
import org.dhis2afgamis.uicomponents.map.geometry.point.MapPointToFeature
import org.dhis2afgamis.uicomponents.map.geometry.polygon.MapPolygonPointToFeature
import org.dhis2afgamis.uicomponents.map.geometry.polygon.MapPolygonToFeature
import org.dhis2afgamis.uicomponents.map.mapper.MapRelationshipToRelationshipMapModel
import org.dhis2afgamis.uicomponents.map.mocks.RelationshipUiCompomentDummy
import org.dhis2afgamis.uicomponents.map.mocks.RelationshipViewModelDummy
