...
# subprocess.call(".././gradlew --stacktrace app:connectedAndroidTest -P android.testInstrumentationRunnerArguments.class=medhis2yes.usecases.main.MainTest#copyDatabase", shell=True)
